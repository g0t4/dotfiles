#!/usr/bin/env python3
"""Generate Xonsh declarations from Fish dotnet abbreviations."""
...
SOURCE = ROOT / "fish/load_last_interactive_only/dotnet.fish"
TARGET = ROOT / ".config/xonsh/lib/wes_dotnet_abbreviations.py"
