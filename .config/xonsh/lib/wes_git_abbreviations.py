...
def register_git_abbreviations():
    ...
    abbr('glp', "git log --patch 'HEAD@{push}~1..HEAD'")
    abbr('glpf', "git log --pretty=full --patch 'HEAD@{push}~1..HEAD'")
    abbr(re.compile('glpf?\\d+'), abbr_from_fish_function('glp_x'))
    abbr('gls', "git log --stat 'HEAD@{push}~1..HEAD'_without_last_pushed")
    abbr('glsf', "git log --pretty=full --stat 'HEAD@{push}~1..HEAD'_without_last_pushed")
    ...
    abbr('gd_stat', "git diff --stat 'HEAD@{push}~1..HEAD'_without_last_pushed")
