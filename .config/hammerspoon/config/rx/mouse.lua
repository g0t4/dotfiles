...
function M.mouseMovesObservable(delay_ms)
    ...
    local function stop()
        ...
        scheduler:stop()
        -- TODO I fill like this should be using unsubscribe to stop the timer at least.. and maybe also the event source if I make that interface return a Subscription too
    end
