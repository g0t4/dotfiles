...
if command -q act
    ...
    complete -c act -l actor -d 'Description for actor'
    ...
    complete -c act -l bind -d 'Description for bind'
    ...
    complete -c act -l directory -d 'Description for directory'
    complete -c act -l dryrun -d 'Description for dryrun'
    complete -c act -l env -d 'Description for env'
    complete -c act -l env -d 'Description for env'
    complete -c act -l env -d 'Description for env'
    complete -c act -l env-file -d 'Description for env-file'
    complete -c act -l eventpath -d 'Description for eventpath'
    complete -c act -l github-instance -d 'Description for github-instance'
    complete -c act -l graph -d 'Description for graph'
    complete -c act -l help -d 'Description for help'
    ...
    complete -c act -l job -d 'Description for job'
    complete -c act -l json -d 'Description for json'
    complete -c act -l list -d 'Description for list'
    ...
    complete -c act -l platform -d 'Description for platform'
    complete -c act -l privileged -d 'Description for privileged'
    complete -c act -l pull -d 'Description for pull'
    complete -c act -l quiet -d 'Description for quiet'
    ...
    complete -c act -l replace-ghe-action-with-github-com -d 'Description for replace-ghe-action-with-github-com'
    complete -c act -l reuse -d 'Description for reuse'
    complete -c act -l rm -d 'Description for rm'
    complete -c act -l secret -d 'Description for secret'
    ...
    complete -c act -l var-file -d 'Description for var-file'
    complete -c act -l verbose -d 'Description for verbose'
    complete -c act -l version -d 'Description for version'
    complete -c act -l watch -d 'Description for watch'
    complete -c act -l workflows -d 'Description for workflows'
