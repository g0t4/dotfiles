...
abbr --set-cursor -- amend_n_deepseek $GIT_FULLY_AUTO_REBASE 'git rebase -i --exec "git commit --amend --no-edit --author \"deepseek-v4-flash-0731<wes.mcclure+deepseek-v4-flash-0731@gmail.com>\"" HEAD~%'
