...
abbr gstiv --set-cursor 'git status --ignored --untracked-files --short ".%" | rg_grep -i -v "node_modules|\.venv/|\.rag/|__pycache__|DS_Store|\.pytest_cache/|/bin/|/obj/|/target/|iterm2env/|egg-info/"'
# also skip image files (don't always do this, hence a separte abbr)
abbr gstiv_all --set-cursor 'git status --ignored --untracked-files --short ".%" | rg_grep -i -v "node_modules|\.venv/|\.rag/|__pycache__|DS_Store|\.pytest_cache/|/bin/|/obj/|/target/|iterm2env/|egg-info/|.*\.(png|bmp|jpg|svg)\$"'
