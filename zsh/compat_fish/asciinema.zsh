ealias anr='asciinema rec --overwrite test.cast' # PRN remake in fish:    abbr --set-cursor '!' --add anr 'asciinema rec --overwrite !.cast'
ealias and='echo lines: $LINES cols: $COLUMNS'
ealias anp='asciinema play'
ealias anu='asciinema upload'
ealias anc='asciinema cat'

ealias aggo="agg --font-size 20 --font-family 'SauceCodePro Nerd Font' --theme 17181d,c7b168,555a6c,dc3d6f,9ed279,fae67f,469cd0,8b47e5,61d2b8,c229cf test.cast test.gif"
