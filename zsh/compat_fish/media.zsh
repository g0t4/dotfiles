...
ealias exifc="grc exiftool -common -duration -AudioFormat -CompressorName" # limit to common metadata that I look for
ealias exifs="grc exiftool -s" # show tag names instead of descriptions
