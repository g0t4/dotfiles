...
eabbr gbv 'PAGER=none git branch -vv' # -v for last commmit (sha+message) & -vv adds remote tracked branch
eabbr gba 'PAGER=none git branch --all -vv'
eabbr gbr 'PAGER=none git branch --remotes -vv'
# branch delete:
