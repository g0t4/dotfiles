...
abbr pcls "prlctl list --full --all"          # all VMs (regardless state) - and full so I get IPs
abbr pclsj "prlctl list --full --json --info" # super detailed json output # --all is irrelevant with --info
