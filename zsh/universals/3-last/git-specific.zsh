...
abbr git_stash_push 'git stash push --message "' --NoSpaceAfter
abbr git_stash_save 'git stash push --message "' --NoSpaceAfter
#
...
for i in {1..10}; do ealias "gdlc$i"="git log --patch  HEAD~$i..HEAD~$(($i - 1))"; done # !FISHISSUE abbr+regex!
