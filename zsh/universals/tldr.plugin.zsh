...
# above is from:
# URL=https://raw.githubusercontent.com/tldr-pages/tldr-c-client/master/autocomplete/complete.zsh
#
# # FYI new style completion does exist:
# FROM https://github.com/tldr-pages/tldr-node-client/blob/master/bin/completion/zsh/_tldr
#    but uses option that my version of tldr doesn't support tldr -a1
#       port it?
#